...
public class Client {
    public static void main(String[] args) throws IOException {
        ...
        /*String[] valasz = (sc.nextLine()).split(" ");
        System.out.println("Az allatkert etetesi ideje: " + valasz[0]);
        System.out.println("Az allatkert koltsege: " + valasz[1]);*/
